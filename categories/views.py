...
from .forms import CategoryForm, SubCategoryForm, MaterialForm
...
class ListMaterialView(TemplateView):
    template_name = 'list_material.html'

    def get_context_data(self, **kwargs):
        context = super(ListMaterialView, self).get_context_data(**kwargs)
        context['form'] = MaterialForm(self.request.POST or None)
...
class DetailMaterialView(DetailView):
    model = Material
    template_name = 'detail_material.html'

    def get_context_data(self, **kwargs):
        context = super(DetailMaterialView, self).get_context_data(**kwargs)
        context['form'] = MaterialForm(self.request.POST or None, instance=context['material'])
        return context
...
class DeleteMaterialView(DeleteView):
    ...
    success_url = reverse_lazy('categories:list_material')
...
list_material = ListMaterialView.as_view()
detail_material = DetailMaterialView.as_view()
delete_material = DeleteMaterialView.as_view()